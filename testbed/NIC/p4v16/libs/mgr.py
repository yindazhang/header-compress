...
class Manager(object):
  ...
  def add_rule_exact_read_action_arg2(self, tbl_name, action_name, match_arg_name, match_arg, action_arg_name0, action_arg0, action_arg_name1, action_arg1):
    table = self.bfrt_info.table_get(tbl_name)
    table.entry_add(
      self.target,
      [table.make_key([gc.KeyTuple(match_arg_name, match_arg)])],
      [table.make_data([gc.DataTuple(action_arg_name0, action_arg0),
                        gc.DataTuple(action_arg_name1, action_arg1)], action_name)],
    )
  ...
  def add_rule_exact_read4_action_arg(self, tbl_name, action_name, match_arg_name0, match_arg0, match_arg_name1, match_arg1, \
  										match_arg_name2, match_arg2, match_arg_name3, match_arg3, action_arg_name, action_arg):
    table = self.bfrt_info.table_get(tbl_name)
    table.entry_add(
      self.target,
      [table.make_key([gc.KeyTuple(match_arg_name0, match_arg0),
                       gc.KeyTuple(match_arg_name1, match_arg1),
                       gc.KeyTuple(match_arg_name2, match_arg2),
                       gc.KeyTuple(match_arg_name3, match_arg3)])],
      [table.make_data([gc.DataTuple(action_arg_name, action_arg)], action_name)],
    )
